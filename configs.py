...
try:
    class A(BaseModel):
        config_type: Literal['base', 'smoke'] = 'smoke'
except:
    print("A failed")
else:
    print("A succeeded")
...
try:
    class B(BaseModel):
        config_type: Literal['base', 'smoke'] = Literal['smoke']
except:
    print("B failed")
else:
    print("B succeeded")
...
try:
    class C(BaseModel):
        config_type: Literal['smoke'] = 'smoke'
except:
    print("C failed")
else:
    print("C succeeded")
...
try:
    class D(BaseModel):
        config_type: Literal['smoke'] = Literal['smoke']
except:
    print("D failed")
else:
    print("D succeeded")
